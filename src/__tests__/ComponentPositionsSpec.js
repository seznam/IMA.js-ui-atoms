...
describe('ComponentPositions', () => {
	...
	describe('getRectsIntersection method', () => {
		...
		it('should return penetration rect from two defined rects', () => {
			let penetrationRect = componentPositions.getRectsIntersection(windowViewportRect, elmRect);
	...
	describe('getPercentOfVisibility method', () => {
		...
		it('should return percent of visibility on window viewport', () => {
			...
			let percentOfVisibility = componentPositions.getPercentOfVisibility(elmRect);
	...
	describe('getBoundingClientRect method', () => {
		...
		it('should returns expanded size for element', () => {
			...
			expect(componentPositions.getBoundingClientRect(element, {}, 300)).toEqual({
				top: -370,
				left: 162,
				width: 700,
				height: 700
